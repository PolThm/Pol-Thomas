  ...
  render() {
    return (
      <div>
        ...
        <footer>
          <p className={'text-footer'}>Copyright 2020 <span className={"realisedBy"}>par Pol Thomas </span>- <span className={'text-mentions-legales'} onClick={this.openModalMentionsLegales}>Mentions légales</span></p>

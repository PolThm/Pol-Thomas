  ...
  render() {
    return (
      <div>
        ...
        <footer>
          <p className={'text-footer'}>Copyright {new Date().getFullYear()} <span className={"realisedBy"}>par Pol Thomas </span>- <span className={'text-mentions-legales'} onClick={this.openModalMentionsLegales}>Mentions légales</span></p>
